...
<footer class="px-4 divide-y bg-base border-t border-0 border-green text-green">
    <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div class="space-y-3">
                <h3 class="tracking-wide uppercase font-bold">Art</h3>
                <ul class="space-y-1">
                    {#each nav as n}
                        <li>
            ...
            <div class="space-y-3">
                <div class="uppercase font-bold">Me suivre</div>
                <div class="flex justify-start space-x-3">
                    <a target="_blank" rel="noopener noreferrer" href="{home.facebook}" title="Facebook" class="flex items-center p-1">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="{home.instagram}" title="Instagram" class="flex items-center p-1">
    ...
    <div class="py-6 text-sm text-center">© 2023 <a href="https://github.com/0grre" target="_blank">0grre</a>. All rights reserved.</div>
</footer>
