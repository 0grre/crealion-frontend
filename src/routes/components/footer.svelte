...
<footer class="px-4 divide-y bg-base border-t border-0 border-green text-green">
    <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div class="lg:w-1/3">
            <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
                ...
                <span class="self-center font-inter uppercase text-2xl font-light italic">crea<span class="font-thin">lion</span></span>
            </a>
        </div>
        <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-1">
                    <li>
                        <a rel="noopener noreferrer" href="#">Politique de confidentialité</a>
                    </li>
                    <li>
    ...
    <div class="py-6 text-sm text-center dark:text-gray-400">© 2023 <a href="https://github.com/0grre" target="_blank">0grre</a>. All rights reserved.</div>
</footer>
